...
\end{esempiot}
	...
	%	\centering
		\begin{align*}
		\num{27,47}\overline{932}=\AddNode\\[0.5cm] 
		=\dfrac{\num{2747932} -\phantom{2747}}{\phantom{99900}}=\AddNode\\[0.5cm] %\AddNode[2]\\ 
		=\dfrac{\num{2747932}-\num{2747}}{\phantom{99900}}=\AddNode\\[0.5cm]
		=\dfrac{\num{2747932}-\num{2747}}{\num{999}\phantom{00}}=\AddNode\\[0.5cm]
		=\dfrac{\num{2747932}-\num{2747}}{\num{99900}}=\AddNode\\[0.5cm]
		=\dfrac{\num{2747185}}{\num{99900}}\AddNode
		\end{align*}
		\tikzset{LabelStyle/.style = {left=-0.8cm,pos=0.5,above,text=red,fill=white}}
		\LinkNodes[margin=2cm]{\begin{minipage}[h]{3.5cm}
...
\end{enumerate}
\end{procedurat}
\begin{esempiot}{Semplificare la frazione}{}
...
\section{Operazioni}
	...
	\end{enumerate}
	\begin{esempiot}{Moltiplicazione di frazione con frazione}{}
	...
	\end{esempiot}	
	 \begin{center}
						...
						\end{tikzpicture}%
			\end{center}
\begin{esempiot}{Prodotto numero con frazione}{}
Prodotto numero con frazione		 
	\end{esempiot}  
		   \begin{center}
		 \begin{tikzpicture}[thick]
		 \def\x{2.8mm}
	...
	\begin{esempiot}{Semplificazione in verticale}{}
...
Con la moltiplicazione è possibile anche la cosiddetta semplificazione\index{Semplificazione!in croce} in croce. 	In questo caso si semplifica il denominatore della prima frazione con il numeratore della seconda e il numeratore della prima con il denominatore della seconda.
	       \begin{esempiot}{Semplificazione in croce}{}
...
Prima di parlare della divisione fra frazioni occorre introdurre i reciproci. Due numeri sono reciproci\index{Numeri!reciproci} se il loro prodotto è uno.
