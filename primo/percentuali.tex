...
\end{figure}
 ...
 \end{esempiot}
Per risolvere l'esercizio bisogna trovare quanto è l'importo dello sconto e successivamente  la sua percentuale rispetto al costo iniziale. Procediamo come segue:
 \begin{align*}
...
Un tostapane costa \EUR{40}. Viene scontato del \SI{20}{\percent}
\end{esempiot}