...
\end{figure}
 ...
 Lo ${Sconto}_{percentuale}$ non è espresso in Euro dato che è un numero puro non un valore monetario.
 ...
 \end{esempiot}
Per risolvere l'esercizio bisogna calcolare quanto è l'importo dello sconto e successivamente  la sua percentuale rispetto al costo iniziale. Procediamo come segue:
 \begin{align*}
