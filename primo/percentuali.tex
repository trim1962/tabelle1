...
Un libro viene venduto a \EUR{23.75} scontato del \SI{5}{\percent}: Quale era il suo prezzo iniziale?
\end{esempiot}
...
\end{align*}
	...
	Un libro antico del valore di \EUR{500} viene venduto a \EUR{600}. 
	\begin{align*}
...
L'interesse\index{Interesse} è l'utile ricavato dal prestito di un capitale per un determinato periodo di tempo.
\[I=\dfrac{C\cdot r}{100}\cdot t\]
Dove:\begin{description}
	\item[I] Interesse
	\item[C] Capitale\index{Capitale}
	\item[r] ragione\index{ragione} o tasso percentuale
	\item[t] tempo in anni
\end{description}
La formula cambia se il tempo è espresso in mesi
\[I=\dfrac{C\cdot r}{100}\cdot \dfrac{t}{12}\]
La formula cambia se il tempo è espresso in giorni civili\index{Anno!civile}
\[I=\dfrac{C\cdot r}{100}\cdot \dfrac{t}{360}\]
La formula cambia se il tempo è espresso in giorni di un anno commerciale\index{Anno!commerciale}
\[I=\dfrac{C\cdot r}{100}\cdot \dfrac{t}{365}\]
	\begin{esempiot}{Conosco Capitale, tasso e tempo}{}
Un capitale di \EUR{1500} è impiegato al tasso del \SI{5}{\percent} per un anno quale interesse frutta?
\end{esempiot}
\begin{align*}
	C=&\mbox{\EUR{1500}}\\
	r=&\SI{5}{\percent} \\
...
\end{align*}
	\begin{esempiot}{Conosco Capitale, tasso e tempo}{}
	Un capitale di \EUR{3500} è impiegato al tasso del \SI{8}{\percent}annuo  per un 7 mesi. Quale interesse frutta?
\end{esempiot}
\begin{align*}
	C=&\mbox{\EUR{3500}}\\
	r=&\SI{8}{\percent} \\
...
\[r=\dfrac{I\cdot 100}{C\cdot t}\]
	...
	Un capitale di \EUR{7500} ha reso in un anno un interesse di \EUR{150}. Quale è stato li tasso di interesse?
\end{esempiot}
\begin{align*}
	C=&\mbox{\EUR{7500}}\\
	t=&1\\
...
\end{align*}
\section{Montante}
Il montante\index{Montante} è il valore del capitale alla fine di un periodo temporale comprensivo del capitale iniziale e degli interessi.
\[M=C+I\]