...
\begin{figure}
	...
	\label{fig:sconto}
\end{figure}
 In un supermercato troviamo sotto un televisore l'etichetta come la~\cref*{fig:sconto}. Abbiamo un prezzo iniziale di \EUR{600}, un prezzo scontato  di \EUR{340}. La differenza tra i due prezzi è lo sconto\index{Sconto}. Vale la seguente relazione:\[ Prezzo iniziale- Prezzo finale=Sconto\] In questo caso lo sconto è di \EUR{260}. Possiamo definire uno sconto percentuale. Dobbiamo trovare quindi una parte e un tutto. La parte è ovviamente lo $Sconto$. Il tutto è il $Prezzo iniziale$ infatti \[Prezzo iniziale=Prezzo finale+Sconto\]Quindi lo $Sconto$ è una parte del $Prezzo iniziale$ Possiamo definire lo \[Sconto percentuale=\dfrac{Sconto}{Prezzo iniziale}\cdot 100\]